...
import 'package:ramadany/Days%20Details/day6details.dart';
...
class _Day6State extends State<Day6> {
 ...
 int missionsResult = 0;
  int index = 6; 
  String day6 = ArabicNumbers().convert(6); 
...
@override
            ...
            child: InkWell(
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context)=> showhero(index,)));
              ...
              child: Hero(
                ...
                children: [
                  Text('$day6',style: TextStyle(fontSize: 30,decorationThickness: 3,color: Colors.white,
 ...
 showhero(int index){
   return Day6Details(index: index,);
 }
