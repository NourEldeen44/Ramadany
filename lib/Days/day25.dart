...
import 'package:ramadany/Days%20Details/day25details.dart';
import 'package:ramadany/storage.dart';
class Day25 extends StatefulWidget {
  @override
  _Day25State createState() => _Day25State();
}
...
@override
            ...
            child: InkWell(
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context)=> showhero(index,)));
              ...
              child: Hero(
                ...
                children: [
                  Text('$day25',style: TextStyle(fontSize: 30,decorationThickness: 3,color: Colors.white,
 ...
 showhero(int index){
   return Day25Details(index: index,);
 }
