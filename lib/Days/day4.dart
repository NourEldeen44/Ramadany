...
import 'package:ramadany/Days%20Details/day4details.dart';
...
class _Day4State extends State<Day4> {
 ...
 int missionsResult = 0;
  int index = 4; 
  String day4 = ArabicNumbers().convert(4); 
...
@override
            ...
            child: InkWell(
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context)=> showhero(index,)));
              ...
              child: Hero(
                ...
                children: [
                  Text('$day4',style: TextStyle(fontSize: 30,decorationThickness: 3,color: Colors.white,
 ...
 showhero(int index){
   return Day4Details(index: index,);
 }
