...
import 'package:ramadany/Days%20Details/day26details.dart';
import 'package:ramadany/storage.dart';
class Day26 extends StatefulWidget {
  @override
  _Day26State createState() => _Day26State();
}
...
@override
            ...
            child: InkWell(
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context)=> showhero(index,)));
              ...
              child: Hero(
                ...
                children: [
                  Text('$day26',style: TextStyle(fontSize: 30,decorationThickness: 3,color: Colors.white,
 ...
 showhero(int index){
   return Day26Details(index: index,);
 }
