...
import 'package:ramadany/Days%20Details/day21details.dart';
...
@override
            ...
            child: InkWell(
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context)=> showhero(index,)));
              ...
              child: Hero(
                ...
                children: [
                  Text('$day21',style: TextStyle(fontSize: 30,decorationThickness: 3,color: Colors.white,
 ...
 showhero(int index){
   return Day21Details(index: index,);
 }
