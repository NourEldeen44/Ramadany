...
import 'package:ramadany/Days%20Details/day27details.dart';
import 'package:ramadany/storage.dart';
class Day27 extends StatefulWidget {
  @override
  _Day27State createState() => _Day27State();
}
...
@override
            ...
            child: InkWell(
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context)=> showhero(index,)));
              ...
              child: Hero(
                ...
                children: [
                  Text('$day27',style: TextStyle(fontSize: 30,decorationThickness: 3,color: Colors.white,
 ...
 showhero(int index){
   return Day27Details(index: index,);
 }
