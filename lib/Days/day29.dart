...
import 'package:ramadany/Days%20Details/day29details.dart';
import 'package:ramadany/storage.dart';
class Day29 extends StatefulWidget {
  @override
  _Day29State createState() => _Day29State();
}
...
@override
            ...
            child: InkWell(
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context)=> showhero(index,)));
              ...
              child: Hero(
                ...
                children: [
                  Text('$day29',style: TextStyle(fontSize: 30,decorationThickness: 3,color: Colors.white,
 ...
 showhero(int index){
   return Day29Details(index: index,);
 }
