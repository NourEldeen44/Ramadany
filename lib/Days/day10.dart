...
import 'package:ramadany/Days%20Details/day10details.dart';
...
@override
    ...
    return Directionality(
        ...
        child: Card( color:Colors.greenAccent[400],
          ...
          image:AssetImage('images/day.png'))),
            child: InkWell(
             onTap: HijriCalendar.now().isBefore(1442, 9, index)?()
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context)=> showhero(index,)));
              ...
              child: Hero(
                ...
                children: [
                  Text('$day10',style: TextStyle(fontSize: 30,decorationThickness: 3,color: Colors.white,
 ...
 showhero(int index){
   return Day10Details(index: index,);
 }
