...
import 'package:ramadany/Days%20Details/day28details.dart';
import 'package:ramadany/storage.dart';
class Day28 extends StatefulWidget {
  @override
  _Day28State createState() => _Day28State();
}
...
@override
            ...
            child: InkWell(
             ...
             Navigator.push(context, MaterialPageRoute(builder: (context)=> showhero(index,)));
              ...
              child: Hero(
                ...
                children: [
                  Text('$day28',style: TextStyle(fontSize: 30,decorationThickness: 3,color: Colors.white,
 ...
 showhero(int index){
   return Day28Details(index: index,);
 }
