...
class Day9Details extends StatefulWidget {
 final  int index;
  Day9Details({this.index});
  @override
  _Day9DetailsState createState() => _Day9DetailsState();
}

class _Day9DetailsState extends State<Day9Details> {

  String _hadithSource = HadithStorage().hadith9['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith9['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day9 = ArabicNumbers().convert(9);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day9 '+'رمضان',style: TextStyle(fontSize: 30,
