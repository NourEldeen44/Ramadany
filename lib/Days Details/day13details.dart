...
class Day13Details extends StatefulWidget {
 final int index;
  Day13Details({this.index});
  @override
  _Day13DetailsState createState() => _Day13DetailsState();
}

class _Day13DetailsState extends State<Day13Details> {

  String _hadithSource = HadithStorage().hadith13['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith13['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day13 = ArabicNumbers().convert(13);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day13 '+'رمضان',style: TextStyle(fontSize: 30,
