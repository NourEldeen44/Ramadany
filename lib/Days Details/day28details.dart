...
class Day28Details extends StatefulWidget {
 final int index;
  Day28Details({this.index});
  @override
  _Day28DetailsState createState() => _Day28DetailsState();
}

class _Day28DetailsState extends State<Day28Details> {

  String _hadithSource = HadithStorage().hadith28['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith28['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day28 = ArabicNumbers().convert(28);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day28 '+'رمضان',style: TextStyle(fontSize: 30,
