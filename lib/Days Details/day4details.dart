...
class _Day4DetailsState extends State<Day4Details> {
  ...
  String _hadithSource = HadithStorage().hadith4['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith4['heart']; 
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day4 '+'رمضان',style: TextStyle(fontSize: 30,
