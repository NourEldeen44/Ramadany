...
class Day24Details extends StatefulWidget {
 final int index;
  Day24Details({this.index});
  @override
  _Day24DetailsState createState() => _Day24DetailsState();
}

class _Day24DetailsState extends State<Day24Details> {

  String _hadithSource = HadithStorage().hadith24['an'];
  ...
  String _hadithHeart = HadithStorage().hadith24['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day24 = ArabicNumbers().convert(24);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day24 '+'رمضان',style: TextStyle(fontSize: 30,
