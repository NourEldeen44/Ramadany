...
class Day22Details extends StatefulWidget {
 final int index;
  Day22Details({this.index});
  @override
  _Day22DetailsState createState() => _Day22DetailsState();
}

class _Day22DetailsState extends State<Day22Details> {

  String _hadithSource = HadithStorage().hadith22['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith22['heart']; 
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day22 '+'رمضان',style: TextStyle(fontSize: 30,
