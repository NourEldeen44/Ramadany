...
class Day17Details extends StatefulWidget {
 final int index;
  Day17Details({this.index});
  @override
  _Day17DetailsState createState() => _Day17DetailsState();
}

class _Day17DetailsState extends State<Day17Details> {

  String _hadithSource = HadithStorage().hadith17['an'];
  ...
  String _hadithHeart = HadithStorage().hadith17['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day17 = ArabicNumbers().convert(17);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day17 '+'رمضان',style: TextStyle(fontSize: 30,
