...
class Day6Details extends StatefulWidget {
 final int index;
  Day6Details({this.index});
  @override
  _Day6DetailsState createState() => _Day6DetailsState();
}

class _Day6DetailsState extends State<Day6Details> {

  String _hadithSource = HadithStorage().hadith6['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith6['heart']; 
