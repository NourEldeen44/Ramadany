...
class Day11Details extends StatefulWidget {
 final int index;
  Day11Details({this.index});
  @override
  _Day11DetailsState createState() => _Day11DetailsState();
}

class _Day11DetailsState extends State<Day11Details> {

  String _hadithSource = HadithStorage().hadith11['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith11['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day11 = ArabicNumbers().convert(11);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day11 '+'رمضان',style: TextStyle(fontSize: 30,
