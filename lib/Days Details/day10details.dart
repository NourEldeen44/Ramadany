...
class Day10Details extends StatefulWidget {
 final  int index;
  Day10Details({this.index});
  @override
  _Day10DetailsState createState() => _Day10DetailsState();
}

class _Day10DetailsState extends State<Day10Details> {

  String _hadithSource = HadithStorage().hadith10['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith10['heart'];
  // 'قال رسول الله صلى الله عليه وسلم';
  String day10 = ArabicNumbers().convert(10);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day10 '+'رمضان',style: TextStyle(fontSize: 30,
