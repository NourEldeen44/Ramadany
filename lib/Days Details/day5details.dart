...
class Day5Details extends StatefulWidget {
 final int index;
  Day5Details({this.index});
  @override
  _Day5DetailsState createState() => _Day5DetailsState();
}

class _Day5DetailsState extends State<Day5Details> {

  String _hadithSource = HadithStorage().hadith5['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith5['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day5 = ArabicNumbers().convert(5);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day5 '+'رمضان',style: TextStyle(fontSize: 30,
