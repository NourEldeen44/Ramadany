...
class Day3Details extends StatefulWidget {
 final int index;
  Day3Details({this.index});
  @override
  _Day3DetailsState createState() => _Day3DetailsState();
}

class _Day3DetailsState extends State<Day3Details> {

  String _hadithSource = HadithStorage().hadith3['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith3['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day3 = ArabicNumbers().convert(3);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day3 '+'رمضان',style: TextStyle(fontSize: 30,
