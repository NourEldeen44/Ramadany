...
class Day16Details extends StatefulWidget {
 final int index;
  Day16Details({this.index});
  @override
  _Day16DetailsState createState() => _Day16DetailsState();
}

class _Day16DetailsState extends State<Day16Details> {

  String _hadithSource = HadithStorage().hadith16['an'];
  ...
  String _hadithHeart = HadithStorage().hadith16['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day16 = ArabicNumbers().convert(16);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day16 '+'رمضان',style: TextStyle(fontSize: 30,
