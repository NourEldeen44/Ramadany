...
class Day12Details extends StatefulWidget {
 final int index;
  Day12Details({this.index});
  @override
  _Day12DetailsState createState() => _Day12DetailsState();
}

class _Day12DetailsState extends State<Day12Details> {

  String _hadithSource = HadithStorage().hadith12['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith12['heart']; 
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day12 '+'رمضان',style: TextStyle(fontSize: 30,
