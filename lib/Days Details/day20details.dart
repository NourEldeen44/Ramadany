...
class Day20Details extends StatefulWidget {
 final int index;
  Day20Details({this.index});
  @override
  _Day20DetailsState createState() => _Day20DetailsState();
}

class _Day20DetailsState extends State<Day20Details> {

  String _hadithSource = HadithStorage().hadith20['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith20['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day20 = ArabicNumbers().convert(20);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day20 '+'رمضان',style: TextStyle(fontSize: 30,
