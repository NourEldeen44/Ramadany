...
class Day26Details extends StatefulWidget {
 final int index;
  Day26Details({this.index});
  @override
  _Day26DetailsState createState() => _Day26DetailsState();
}

class _Day26DetailsState extends State<Day26Details> {

  String _hadithSource = HadithStorage().hadith26['an'];
  ...
  String _hadithHeart = HadithStorage().hadith26['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day26 = ArabicNumbers().convert(26);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day26 '+'رمضان',style: TextStyle(fontSize: 30,
