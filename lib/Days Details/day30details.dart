...
class Da30Details extends StatefulWidget {
 final int index;
  Da30Details({this.index});
  @override
  _Da30DetailsState createState() => _Da30DetailsState();
}

class _Da30DetailsState extends State<Da30Details> {

  String _hadithSource = HadithStorage().hadith30['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith30['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day30 = ArabicNumbers().convert(30);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day30 '+'رمضان',style: TextStyle(fontSize: 30,
