...
class Day21Details extends StatefulWidget {
 final int index;
  Day21Details({this.index});
  @override
  _Day21DetailsState createState() => _Day21DetailsState();
}

class _Day21DetailsState extends State<Day21Details> {

  String _hadithSource = HadithStorage().hadith21['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith21['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day21 = ArabicNumbers().convert(21);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day21 '+'رمضان',style: TextStyle(fontSize: 30,
