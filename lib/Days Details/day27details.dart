...
class Day27Details extends StatefulWidget {
 final int index;
  Day27Details({this.index});
  @override
  _Day27DetailsState createState() => _Day27DetailsState();
}

class _Day27DetailsState extends State<Day27Details> {

  String _hadithSource = HadithStorage().hadith27['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith27['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day27 = ArabicNumbers().convert(27);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day27 '+'رمضان',style: TextStyle(fontSize: 30,
