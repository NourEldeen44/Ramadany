...
class Day25Details extends StatefulWidget {
 final int index;
  Day25Details({this.index});
  @override
  _Day25DetailsState createState() => _Day25DetailsState();
}

class _Day25DetailsState extends State<Day25Details> {

  String _hadithSource = HadithStorage().hadith25['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith25['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day25 = ArabicNumbers().convert(25);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day25 '+'رمضان',style: TextStyle(fontSize: 30,
