...
class Day18Details extends StatefulWidget {
 final int index;
  Day18Details({this.index});
  @override
  _Day18DetailsState createState() => _Day18DetailsState();
}

class _Day18DetailsState extends State<Day18Details> {

  String _hadithSource = HadithStorage().hadith18['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith18['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day18 = ArabicNumbers().convert(18);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day18 '+'رمضان',style: TextStyle(fontSize: 30,
