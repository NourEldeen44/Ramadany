...
class Day14Details extends StatefulWidget {
 final int index;
  Day14Details({this.index});
  @override
  _Day14DetailsState createState() => _Day14DetailsState();
}

class _Day14DetailsState extends State<Day14Details> {

  String _hadithSource = HadithStorage().hadith14['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith14['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day14 = ArabicNumbers().convert(14);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day14 '+'رمضان',style: TextStyle(fontSize: 30,
