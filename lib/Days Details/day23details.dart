...
class Day23Details extends StatefulWidget {
 final int index;
  Day23Details({this.index});
  @override
  _Day23DetailsState createState() => _Day23DetailsState();
}

class _Day23DetailsState extends State<Day23Details> {

  String _hadithSource = HadithStorage().hadith23['an'];
  ...
  String _hadithHeart = HadithStorage().hadith23['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day23 = ArabicNumbers().convert(23);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day23 '+'رمضان',style: TextStyle(fontSize: 30,
