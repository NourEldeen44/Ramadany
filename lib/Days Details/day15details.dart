...
class Day15Details extends StatefulWidget {
 final int index;
  Day15Details({this.index});
  @override
  _Day15DetailsState createState() => _Day15DetailsState();
}

class _Day15DetailsState extends State<Day15Details> {

  String _hadithSource = HadithStorage().hadith15['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith15['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day15 = ArabicNumbers().convert(15);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day15 '+'رمضان',style: TextStyle(fontSize: 30,
