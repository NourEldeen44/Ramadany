...
class Day1Details extends StatefulWidget {
 final int index;
  Day1Details({this.index});
  @override
  _Day1DetailsState createState() => _Day1DetailsState();
}

class _Day1DetailsState extends State<Day1Details> {

  String _hadithSource = HadithStorage().hadith1['an']; //note to be changed by index
  ...
  String _hadithHeart = HadithStorage().hadith1['heart']; //note to be changed by index
  // 'قال رسول الله صلى الله عليه وسلم';
  String day1 = ArabicNumbers().convert(1);//note to be changed by index
  ...
  Storage storage = new Storage();
    ...
    bool qiam = false;
    int tasksResult = 0;
    int index = 1;//note to be changed by index
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day1 '+'رمضان',style: TextStyle(fontSize: 30,
