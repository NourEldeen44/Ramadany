...
class Day7Details extends StatefulWidget {
 final int index;
  Day7Details({this.index});
  @override
  _Day7DetailsState createState() => _Day7DetailsState();
}

class _Day7DetailsState extends State<Day7Details> {

  String _hadithSource = HadithStorage().hadith7['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith7['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day7 = ArabicNumbers().convert(7);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day7 '+'رمضان',style: TextStyle(fontSize: 30,
