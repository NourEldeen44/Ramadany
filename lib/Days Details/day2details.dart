...
class Day2Details extends StatefulWidget {
 final int index;
  Day2Details({this.index});
  @override
  _Day2DetailsState createState() => _Day2DetailsState();
}

class _Day2DetailsState extends State<Day2Details> {

  String _hadithSource = HadithStorage().hadith2['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith2['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day2 = ArabicNumbers().convert(2);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day2 '+'رمضان',style: TextStyle(fontSize: 30,
