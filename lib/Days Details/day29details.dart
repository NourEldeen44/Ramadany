...
class Day29Details extends StatefulWidget {
 final int index;
  Day29Details({this.index});
  @override
  _Day29DetailsState createState() => _Day29DetailsState();
}

class _Day29DetailsState extends State<Day29Details> {

  String _hadithSource = HadithStorage().hadith29['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith29['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day29 = ArabicNumbers().convert(29);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day29 '+'رمضان',style: TextStyle(fontSize: 30,
