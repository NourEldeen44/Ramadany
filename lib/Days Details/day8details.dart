...
class Day8Details extends StatefulWidget {
 final int index;
  Day8Details({this.index});
  @override
  _Day8DetailsState createState() => _Day8DetailsState();
}

class _Day8DetailsState extends State<Day8Details> {

  String _hadithSource = HadithStorage().hadith8['an']; 
  ...
  String _hadithHeart = HadithStorage().hadith8['heart']; 
  // 'قال رسول الله صلى الله عليه وسلم';
  String day8 = ArabicNumbers().convert(8);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('$day8 '+'رمضان',style: TextStyle(fontSize: 30,
